defmodule MehrSchulferienWeb.Admin.FederalStateController do
  ...
  def create(conn, %{"federal_state" => federal_state_params}) do
    case Locations.create_federal_state(federal_state_params) do
      {:ok, federal_state} ->
        ...
        |> redirect(to: admin_federal_state_path(conn, :show, federal_state))
  ...
  def delete(conn, %{"id" => id}) do
    ...
    |> redirect(to: admin_federal_state_path(conn, :index))
  end
end
