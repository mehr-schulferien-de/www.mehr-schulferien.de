defmodule MehrSchulferienWeb.CategoryControllerTest do
  use MehrSchulferienWeb.ConnCase

  alias MehrSchulferien.Timetables

  @create_attrs %{for_anybody: true, for_students: true, name: "some name", needs_exeat: true, slug: "some slug"}
  ...
  def fixture(:category) do
    {:ok, category} = Timetables.create_category(@create_attrs)
    category
  end
