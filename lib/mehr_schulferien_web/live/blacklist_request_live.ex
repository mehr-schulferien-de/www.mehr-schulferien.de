defmodule MehrSchulferienWeb.BlacklistRequestLive do
  ...
  Requires wiki authentication. Users can directly enter patterns
  ...
  def handle_event("confirm_submit", _params, socket) do
    ...
    case PatternMatcher.validate_pattern(pattern) do
      :ok ->
        # Create the blacklist entry using the authenticated user
        attrs = %{
          field_type: field_type,
          pattern: pattern,
        ...
        case Blacklist.create_entry_for_user(attrs, socket.assigns.current_user) do
        ...
        <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4 mb-6">
          <div class="flex items-center">
            ...
            <p class="text-green-800 dark:text-green-300 text-sm">
              <strong>Angemeldet als:</strong> {@current_user.full_name || @current_user.email}
            </p>
          </div>
        </div>
                          ...
                          <div class="flex">
                            ...
                            <div class="ml-3">
                              ...
                              <p class="text-sm text-red-700 dark:text-red-300 mt-1">
                                ...
                                Bitte verwenden Sie ein spezifischeres Muster.
                              </p>
                            </div>
                          </div>
                        </div>
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-grow">
                  ...
                  <div class="mt-4 space-y-3">
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                      Sie sind dabei, folgende Daten dauerhaft zu sperren:
                    </p>
