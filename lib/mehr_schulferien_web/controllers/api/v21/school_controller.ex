  ...
  defp generate_vcard(school) do
    ...
    vcard_lines =
      if address.street && address.zip_code && address.city do
        vcard_lines ++
          ["ADR;WORK:;;#{address.street};#{address.city};;#{address.zip_code};Deutschland"]
      else
        vcard_lines
      end
