defmodule MehrSchulferienWeb.Components.GitHubPromotionComponent do
  ...
  Supports both Bootstrap and Tailwind CSS frameworks.
  """
  use Phoenix.Component

  @doc """
  Renders GitHub promotion section with support for both Bootstrap and Tailwind CSS
  """
  attr :locale, :string, default: "de"
  attr :translate_fn, :any, required: false
  attr :framework, :string, default: "tailwind"
  ...
  def github_promotion(assigns) do
    ...
    if assigns.framework == "bootstrap" do
      ~H"""
      <div class={@wrapper_class || "mt-6 bg-white p-6 rounded-lg shadow-sm border border-gray-200"}>
      ...
      # Tailwind version for LiveView forms
      ~H"""
      <div class={@wrapper_class || "px-6 py-8 sm:px-8 border-t border-slate-200"}>
