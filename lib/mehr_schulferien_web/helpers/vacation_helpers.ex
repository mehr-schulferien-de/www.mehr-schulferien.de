defmodule MehrSchulferienWeb.VacationHelpers do
  @moduledoc """
  Shared helpers for the vacation pages.

  The vacation template directory is compiled by both
  `MehrSchulferienWeb.VacationView` and `MehrSchulferienWeb.VacationHTML`;
