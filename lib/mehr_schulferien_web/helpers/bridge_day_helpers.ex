defmodule MehrSchulferienWeb.BridgeDayHelpers do
  @moduledoc """
  Shared helpers for the bridge day pages.

  The bridge_day template directory is compiled by both
  `MehrSchulferienWeb.BridgeDayView` and `MehrSchulferienWeb.BridgeDayHTML`;
  ...
  def format_month_header(start_date, end_date) do
    ...
    cond do
      ...
      first_year != last_year ->
        first_month_abbr = DateHelpers.month_abbreviation(first_month)
