defmodule MehrSchulferienWeb.WikiHelpers do
  @moduledoc """
  Shared helper functions for the wiki templates.

  The wiki template directory is compiled by two modules -
  `MehrSchulferienWeb.WikiView` (rendered from LiveView templates via
  `Phoenix.View.render/3`) and `MehrSchulferienWeb.WikiHTML` (controller
  renders). Both import this module so the helpers exist exactly once.
  """
